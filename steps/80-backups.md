...
5. Install a cron entry or platform-equivalent job to run it using marker replacement. The cron line must include `# RAKKIB: backup-local`; remove any existing line with that marker before adding the new one.
