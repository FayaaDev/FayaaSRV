...
export const translations = {
  en: {
    ...
    services: {
      ...
      'Planning Poker': 'Sprint estimation rooms',
  ...
  ar: {
    ...
    heroText:
      'ركّب يحوّل جهازاً جديداً إلى حزمة خدمات مستضافة ذاتياً للتطبيقات والبيانات والأتمتة والصور والوصول الآمن.',
    copy: 'نسخ',
    copied: 'تم النسخ!',
    installNote:
      'انسخ هذا الأمر وشغّله. ركّب سيجهّز جهازك ويطلق الحزمة خطوة بخطوة.',
    ...
    services: {
      ...
      'Planning Poker': 'جلسات تقدير مهام السبرنت',
